...
from api.handlers.files import FilesUserHandler, FilesHandler, FileHandler, FileUploadHandler
...
HANDLERS = [
    ...
    (r"/friendssuggestions", FriendsSuggestionsApi),
