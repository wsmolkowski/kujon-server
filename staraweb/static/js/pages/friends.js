define(['jquery', 'handlebars', 'main', 'text!templates/friends.html', 'text!templates/error.html'], function($, Handlebars, main, tpl, tplError) {
'use strict';
    return {
        render: function() {
            ...
            var request_url = main.getApiUrl('/api/friends/');
